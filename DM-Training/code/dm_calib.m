...
% measurements (parse_labview_data.m).
...
% remove out-of-aperture actuators with low influence
ignore_out_of_aperture = 0;

% cut aperture by a factor
...
% % EXAMPLE 1 (bmcmultidm140, without piston)
 datasetpath = 'data_individ_tilt_40_20160719_dm-calib.mat';
...
% datasetpath = 'testdata-2016-07-04.mat';
% exclude_piston = 0;
