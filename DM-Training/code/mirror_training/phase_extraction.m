...
%     end
% end
freq_new((-setup.signal_size(1) + setup.img_center(1)):(setup.signal_size(1) + setup.img_center(1)),(-setup.signal_size(2) + setup.img_center(2)):(setup.signal_size(2) + setup.img_center(2))) = ...
    freq_shift((-setup.signal_size(1) + setup.signal_cor(2)):(setup.signal_size(1) + setup.signal_cor(2)),(-setup.signal_size(2) + setup.signal_cor(1)):(setup.signal_size(2) + setup.signal_cor(1)));
